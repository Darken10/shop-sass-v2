...
<head>
    ...
    <title>Transfert r&eacute;ceptionn&eacute; &mdash; {{ $transfer->reference }}</title>
    <style>
    ...
    <table role="presentation" class="w600" width="600" cellspacing="0" cellpadding="0" border="0"
        ...
        <tr><td class="hpad" align="center"
            ...
            <tr><td style="background:rgba(52,211,153,0.22);border-radius:20px;padding:5px 18px;">
                <span style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#a7f3d0;">R&eacute;ception transfert</span>
            </td></tr>
            </table>
            ...
            <!-- Title -->
            <p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:26px;font-weight:800;color:#fff;line-height:1.2;letter-spacing:-0.5px;">Transfert r&eacute;ceptionn&eacute;</p>
            <p style="margin:10px 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:14px;color:rgba(255,255,255,0.70);line-height:1.5;">{{ $transfer->reference }}</p>
        ...
        <tr><td class="pad" style="padding:40px 48px;">
            ...
            <p style="margin:0 0 24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:15px;color:#4a4067;line-height:1.7;">
                Le transfert <strong style="color:#1e1528;">{{ $transfer->reference }}</strong>
                a &eacute;t&eacute; <strong style="color:#059669;">r&eacute;ceptionn&eacute; avec succ&egrave;s</strong>.
            </p>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                ...
                <tr><td style="padding:14px 20px;border-bottom:1px solid #ede8fb;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
                        ...
                        <td align="right" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:13px;color:#1e1528;font-weight:700;">{{ $transfer->reference }}</td>
                    </tr></table>
                </td></tr>
                <tr><td style="padding:14px 20px;border-bottom:1px solid #ede8fb;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
                        ...
                        <td align="right" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:13px;color:#1e1528;font-weight:700;">{{ $transfer->type->label() }}</td>
                    </tr></table>
                </td></tr>
                <tr><td style="padding:14px 20px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
                        ...
                        <td align="right" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:13px;color:#1e1528;font-weight:700;">{{ $transfer->received_at?->format('d/m/Y \à H:i') ?? 'N/A' }}</td>
                    </tr></table>
                </td></tr>
            </table>
            ...
            <p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:14px;color:#4a4067;line-height:1.7;">
                Connectez-vous &agrave; votre espace pour consulter les d&eacute;tails complets de ce transfert.
            </p>
