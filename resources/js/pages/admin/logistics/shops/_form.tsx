...
export default function ShopForm({ defaults = {}, errors }: Props) {
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="grid gap-2">
                                ...
                                <Input id="name" name="name" defaultValue={defaults.name ?? ''} placeholder="Nom du magasin" autoFocus />
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="code" name="code" defaultValue={defaults.code ?? ''} placeholder="SHP-001" className="pl-8" />
                                </div>
                        ...
                        <div className="grid gap-2">
                            ...
                            <textarea
                                ...
                                rows={3}
                                placeholder="Décrivez le magasin…"
