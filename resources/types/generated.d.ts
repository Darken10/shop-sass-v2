...
export enum StockMovementType { PurchaseEntry = 'purchase_entry', SupplierReturn = 'supplier_return', StoreTransfer = 'store_transfer', Loss = 'loss', InternalTransfer = 'internal_transfer', Adjustment = 'adjustment' };
